...
class Contact(Base):
    ...
    )  # Structured custom data from forms
    ...
    bookings = relationship(
        "Booking", back_populates="contact", cascade="all, delete-orphan"
    )
    form_submissions = relationship(
        "FormSubmission", back_populates="contact", cascade="all, delete-orphan"
    )
